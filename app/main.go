...
func (h *hello) Render() app.UI {
	return app.Div().Body(
		...
		app.Raw(`<script src="https://www.gstatic.com/firebasejs/7.12.0/firebase-app.js"></script>`),
		app.Raw(`<script src="https://www.gstatic.com/firebasejs/7.12.0/firebase-analytics.js"></script>`),
		app.Raw(`    <script>
